...
const Waiting = () => (
  <div styleName="block color-primary-2">Waiting for incoming block..</div>
)

const Warning = () => (
  <div styleName="block">
    <div styleName="warning color-primary-2">
    ...
    {({ blocks, hasProvider }) => (
      <div styleName="blocksContainer fade-in-up">
        ...
        {blocks.map((block, idx) => (
          <div key={block.hash} styleName={"block color-primary-3 " + (idx === 0 ? 'fade-in' : '')}>
...
const Heading = () => (
  <div styleName="headerContainer fade-in-down">
    <h1 styleName="header color-primary-1">Latest Ethereum Blocks</h1>
  </div>
)
